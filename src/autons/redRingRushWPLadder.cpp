#include "redRingRushWPLadder.h"

ASSET(redRRworlds_txt); 

void redRingRushWPLadder() {
    ...
    allianceColor =  0; 
    colorSortOn = true; 
    chassis.follow(redRRworlds_txt,8, 2350, true, false);
    ...
    chassis.tank(0,0);
    pros::delay(50);
    chassis.turnToHeading(495, 800, {}, false);


    desiredLiftValue = 147;
    iterations = 0; 
    liftPIDRunning = true; 
    chassis.moveToPose(-24.3, 18.4, 495, 1200, {.lead = 0.25, .minSpeed = 55, .earlyExitRange = 3.5}, false);
    lbMotor1.set_brake_mode(pros::E_MOTOR_BRAKE_COAST); 
    lbMotor2.set_brake_mode(pros::E_MOTOR_BRAKE_COAST); 
    chassis.tank(40, 40);
    pros::delay(300);
    chassis.tank(0,0);
