...
public:
  Button();
  okapi::ControllerDigital buttonList[8] = {okapi::ControllerDigital::L1,okapi::ControllerDigital::Y, okapi::ControllerDigital::X, okapi::ControllerDigital::right, okapi::ControllerDigital::R1, okapi::ControllerDigital::L2, okapi::ControllerDigital::R2, okapi::ControllerDigital::B};
